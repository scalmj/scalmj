...
TRANSFUN[["log10"]]<-list(id="log10",name="Log\u2081\u2080",fun=function(x) log10(x),label=function(x) sprintf("Log\u2081\u2080(%s)",x))
TRANSFUN[["log100"]]<-list(id="log100",name="Log\u2081\u2080(100-x)",fun=function(x) log10(100-x),label=function(x) sprintf("Log\u2081\u2080(100-%s)",x))
